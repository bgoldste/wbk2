...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForecastData.spot'
        db.alter_column(u'core_forecastdata', 'spot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Spot']))

    def backwards(self, orm):

        # Changing field 'ForecastData.spot'
        db.alter_column(u'core_forecastdata', 'spot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Spot'], null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Subscriber', fields ['email_address']
        db.create_unique(u'core_subscriber', ['email_address'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subscriber', fields ['email_address']
        db.delete_unique(u'core_subscriber', ['email_address'])
